...
// Better, more professional homepage images
const searches = [
  // Hero — clean professional electrician portrait or at work
  { query: "professional electrician smiling portrait hard hat", file: "hero-electrician-new.jpg" },
  // Why Us — Licensed & ESA Certified
  { query: "electrician safety gear inspection clipboard professional", file: "feature-licensed-new.jpg" },
  // Why Us — 24/7 Emergency Service
  { query: "electrician emergency night repair urgent service", file: "feature-emergency-new.jpg" },
  // Why Us — Transparent Pricing
  { query: "electrician customer consultation estimate tablet home", file: "feature-pricing-new.jpg" },
  // Why Us — Clean & Professional
  { query: "clean modern home interior lighting bright", file: "feature-clean-new.jpg" },
];
